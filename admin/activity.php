...
<!-------------------SIDEBAR------------------>
					...
					<table id = "table" class = "table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td><center><a href = "edit_activity.php?activity_id=<?php echo $act_fetch['activity_id']?>" class = "btn btn-warning"><span class=  "glyphicon glyphicon-edit"></span> Update</a> 
								<a href = "#" data-toggle = "modal" data-target = "#delete_activity" name = "<?php echo $act_fetch['activity_id']?>" class = "btn btn-danger activity_id"><span class=  "glyphicon glyphicon-trash"></span> Delete</a></center></td>
							</tr>
							<?php
								}
							?>
	...
	<nav class = "navbar-default" id = "footer">
		...
		<label class = "navbar-brand ">manukibet@gmail.com</label>
	</nav>
</body>	
