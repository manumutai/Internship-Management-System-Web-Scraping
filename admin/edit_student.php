...
<!-------------------SIDEBAR0------------------>
	...
	<nav class = "navbar-default" id = "footer">
		<label class = "navbar-brand pull-right">&copy; Internship  Management System <?php echo date('Y', strtotime('+8 HOURS'))?></label>
		<label class = "navbar-brand ">Developed By: Emmanuel Kibet</label>
	</nav>
</body>	
